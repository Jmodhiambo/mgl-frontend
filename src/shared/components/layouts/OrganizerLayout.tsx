...
import { Calendar, LayoutDashboard, Ticket, Users, User, LogOut, Menu, X, ChevronRight, ScanLine, Mail } from 'lucide-react';
...
const OrganizerLayout: React.FC = () => {
  ...
  const navItems: NavItem[] = [
    ...
    { path: '/bulk-emails', label: 'Bulk Email', icon: <Mail className="w-5 h-5" /> },
