      ...
      <div className="min-h-screen bg-gradient-to-br from-orange-50 via-white to-orange-50 pt-16">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
          ...
          <div className="bg-white rounded-xl shadow-md p-8 mb-8">
            ...
            <div className="space-y-3 text-gray-700">
              <div className="flex items-start gap-2">
                ...
                <span>Reselling tickets without authorization from the event organizer</span>
              </div>
              <div className="flex items-start gap-2">
                <XCircle className="w-5 h-5 text-red-500 flex-shrink-0 mt-0.5" />
                <span>Using automated systems (bots) to purchase tickets</span>
              </div>
              <div className="flex items-start gap-2">
                <XCircle className="w-5 h-5 text-red-500 flex-shrink-0 mt-0.5" />
                <span>Creating multiple accounts to circumvent ticket limits</span>
              </div>
              <div className="flex items-start gap-2">
                <XCircle className="w-5 h-5 text-red-500 flex-shrink-0 mt-0.5" />
                <span>Sharing, copying, or distributing ticket codes without permission</span>
              </div>
              <div className="flex items-start gap-2">
                <XCircle className="w-5 h-5 text-red-500 flex-shrink-0 mt-0.5" />
              ...
              <div className="flex items-start gap-2">
                <XCircle className="w-5 h-5 text-red-500 flex-shrink-0 mt-0.5" />
                <span>Engaging in fraudulent activities or payment disputes without valid reason</span>
              </div>
              <div className="flex items-start gap-2">
                <XCircle className="w-5 h-5 text-red-500 flex-shrink-0 mt-0.5" />
              ...
              <div className="flex items-start gap-2">
                <XCircle className="w-5 h-5 text-red-500 flex-shrink-0 mt-0.5" />
                <span>Harassing, threatening, or abusing other users or our staff</span>
              </div>
            </div>
          ...
          <div className="bg-white rounded-xl shadow-md p-8 mb-8">
            ...
            <div className="space-y-4 text-gray-700">
              <p>
                To the maximum extent permitted by law, MGLTickets and its affiliates, officers, directors, employees, and agents shall not be liable for any indirect, incidental, special, consequential, or punitive damages, or any loss of profits or revenues, whether incurred directly or indirectly, or any loss of data, use, goodwill, or other intangible losses resulting from:
              </p>
              <ul className="list-disc list-inside space-y-1 ml-4">
          ...
          <div className="bg-gradient-to-br from-orange-500 to-orange-600 rounded-xl shadow-md p-8 text-white">
            ...
            <div className="space-y-2">
              <p>
                <span className="font-semibold">Email:</span> <a href="mailto:legal@mgltickets.com" className="underline hover:text-orange-100">legal@mgltickets.com</a>
              </p>
              <p>
