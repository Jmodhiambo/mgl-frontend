...
const TicketTypeRow: React.FC<{
  ...
  const inp = (key: keyof FieldErrors) =>
    `w-full px-3 py-2 border rounded-lg text-sm focus:ring-2 focus:ring-purple-400 focus:border-purple-400 transition-all ${
    ...
    <div className="border-2 border-purple-300 rounded-xl bg-purple-50/30 p-4 space-y-3">
      ...
      <div>
        ...
        <textarea
          ...
          className="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm focus:ring-2 focus:ring-purple-400 focus:border-purple-400 transition-all resize-none"
        />
      </div>
        ...
        {tickets.length > 0 && (
          <div className="grid grid-cols-3 gap-3 mb-5">
            ...
            <div className="bg-blue-50 rounded-xl p-3 text-center">
              ...
              <p className="text-xs text-blue-600 mt-0.5">Total Capacity</p>
            </div>
...
export default CreateTicketTypesModal;